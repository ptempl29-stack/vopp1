...
DEFAULT_TABS = {
    "admin": ALL_TABS,
    "doctor": ["dashboard", "patients", "appointments", "telehealth", "notes", "forms", "messages", "assistant"],
    "nurse": ["dashboard", "patients", "appointments", "telehealth", "notes", "forms", "messages", "assistant"],
